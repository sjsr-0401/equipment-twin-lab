...
CLI - template fault
CLI - template expected fault
CLI - template inspection scenario
...
- template expected fault report 경로도 repo root 기준으로 `artifacts\template-fault-expected-failure-report.md`처럼 적는다.
- template inspection scenario report 경로도 repo root 기준으로 `artifacts\template-inspection-scenario-report.md`처럼 적는다.
